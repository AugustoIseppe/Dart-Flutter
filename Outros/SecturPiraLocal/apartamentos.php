...
<head>
    ...
    <title>Apartamentos-Pirassununga</title>
    <style>
        .fa-location-dot {
            color: black;
            /* Cor vinho */
        ...
        #cabecalho-imagem {
            background-image: url(hospedagem/apartamento.jpg);
        }
        #menu {
...
<body>
    ...
    include 'conexao.php';
    include 'menu.php';
    $consulta = $conexao->query('SELECT * FROM `local` WHERE categoriaid= 4');
    ?>


    <div id="cabecalho-imagem">
        <div class="infos-cabecalho">
            <h1>Apartamentos em Pirassununga</h1>
