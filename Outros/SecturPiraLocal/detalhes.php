...
<body>
    ...
    $apiUrl = "https://maps.googleapis.com/maps/api/place/details/json?place_id=$placeId&fields=opening_hours,rating,user_ratings_total,name,reviews&key=$apiKey&language=pt-BR";
    ...
    <div id="container-principal">
        ...
        <div class="image-container">
            <div class="main-image" style="background-color: cornflowerblue;">
                ...
                <img src="assets/uploads/<?php echo $exibir['localfoto1'] ?>" class="imagem-grid">
            </div>
            <div class="image" style="background-color: blueviolet;">
                <!-- Conteúdo da outra imagem 1 -->
                <img src="assets/uploads/<?php echo $exibir['localfoto2'] ?>" class="imagem-grid">
            </div>
            <div class="image" class="imagem-grid">
                <img src="assets/uploads/<?php echo $exibir['localfoto3'] ?>" class="imagem-grid">
                <!-- Conteúdo da outra imagem 2 -->
            </div>
            <div class="image" class="imagem-grid">
                <!-- Conteúdo da outra imagem 3 -->
                <img src="assets/uploads/<?php echo $exibir['localfoto4'] ?>" class="imagem-grid">
            </div>
            <div class="image" class="imagem-grid">
                <img src="assets/uploads/<?php echo $exibir['localfoto5'] ?>" class="imagem-grid">
        ...
        <div class="user-coments">
            ...
            <span>
                ...
                foreach ($reviews as $review) {
                    ...
                    for ($i = 0; $i < $reviewRating; $i++) {
                        $stars .= '<svg xmlns="http://www.w3.org/2000/svg" height="16" width="16" fill="gold" class="bi bi-star-fill" viewBox="0 0 16 16">
                      <path d="M7.976.146a1.2 1.2 0 0 1 1.048.604l1.948 3.94 4.357.63a1.2 1.2 0 0 1 .668 2.043l-3.145 3.075.742 4.325a1.2 1.2 0 0 1-1.733 1.264L8 13.723l-3.89 2.04a1.2 1.2 0 0 1-1.732-1.265l.743-4.324-3.144-3.075a1.2 1.2 0 0 1 .668-2.042l4.357-.63 1.948-3.94a1.2 1.2 0 0 1 1.048-.604z"/>
                   </svg>';
                    }
                    // Exiba a avaliação 
                    echo "   <img src='$authorProfilePhoto' alt='$authorName' class='profile-photo' style='width: 50px; height: 50px; border-radius: 50%; margin-right:10px'>
                
                    
                        <b>$authorName</b> avaliou com $stars 
            ...
            <img src="?php $authorProfilePhoto ?>">
