...
<head>
    ...
    <title>Fazendas-Pirassununga</title>
    <style>
        .fa-location-dot {
            color: black;
            /* Cor vinho */
        ...
        #cabecalho-imagem {
            background-image: url(hospedagem/fazenda.jpg);
        }
        #menu {
...
<body>
    ...
    include 'conexao.php';
    include 'menu.php';
    $consulta = $conexao->query('SELECT * FROM `local` WHERE categoriaid= 5');
    ?>


    <div id="cabecalho-imagem">
        <div class="infos-cabecalho">
            <h1>Fazendas em Pirassununga</h1>
            <p>Venha conhecer as Fazendas do interior paulista!</p>
        </div>
    </div>
