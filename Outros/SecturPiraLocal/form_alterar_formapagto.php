	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-sm-4 col-sm-offset-4">
				...
				<legend>Alteração de Forma de Pagamento</legend>
				
				<form method="post" action="alterar_formapagto.php?id=<?php echo $id_pagamento; ?>" name="alterarPagamento" enctype="multipart/form-data">
				<fieldset>
					...
					<div class="form-group">
						...
						<input maxlength="30" name="pagamento" type="text" value="<?php echo $exibir['formapagtonome']; ?>" class="form-control" required>
