	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-sm-4 col-sm-offset-4">
				...
				<legend>Alteração de Acessibilidade</legend>

				<form method="post" action="alterar_meioacessibilidade.php?id=<?php echo $id_acessibilidade;?>" name="alterarAcessibilidade" enctype="multipart/form-data">
				<fieldset>
					...
					<div class="form-group">
						...
						<input maxlength="50" name="acessibilidade" type="text" value="<?php echo $exibir['acessibilidadenome']; ?>" class="form-control" required>
