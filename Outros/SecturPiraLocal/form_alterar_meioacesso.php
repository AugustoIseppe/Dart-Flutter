	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-sm-4 col-sm-offset-4">
				...
				<legend>Alteração do Meio de Acesso</legend>
				
				<form method="post" action="alterar_meioacesso.php?id=<?php echo $id_meioacesso; ?>" name="alterarMeioAcesso" enctype="multipart/form-data">
				<fieldset>
					...
					<div class="form-group">
						...
						<input maxlength="30" name="meioacesso" type="text" value="<?php echo $exibir['meioacessonome']; ?>"  class="form-control" required>	
