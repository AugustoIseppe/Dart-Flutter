	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-sm-4 col-sm-offset-4">
				...
				<legend>Inclusão de Subcategoria</legend>

				<form method="post" action="incluir_subcategoria.php" name="incluirSubcategoria" enctype="multipart/form-data">
				<fieldset>
					...
					<div class="form-group">
						...
						<input maxlength="30" name="subcategoria" type="text" class="form-control" required>
