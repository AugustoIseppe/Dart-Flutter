...
<head>
    ...
    <style>
        ...
        #cabecalho-imagem {
            background-image: url(http://www.hojetemfrango.com.br/wp-content/uploads/2019/03/shutterstock_1035560875.jpg);
        }
        #menu {
...
<body>
    ...
    include 'conexao.php';
    include 'menu.php';
    $consulta = $conexao->query('SELECT * FROM `local` WHERE categoriaid= 3');
    ?>

    <div id="cabecalho-imagem">
        <div class="infos-cabecalho">
            <h1>Gastronomia em Pirassununga</h1>
            <p>Venha experimentar a culinária do interior paulista!</p>
        </div>
    </div>
                ...
                <div class="conteudo-card">
                    ...
                    <div id="ftr_scl_md">
                       ...
                       <?php if($exibir['localcelularwhatsapp'] != null) { ?>
                        <a href="<?php echo $exibir ['localtelefone'];?>" class="ftr-lnk" id="whatsapp" style="text-decoration: none;">
