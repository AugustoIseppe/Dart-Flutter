...
<head>
    ...
    <title>Área Administrativa - Gastronomia</title>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <br><br><br><br><br>
                ...
                <h3>Área Administrativa - Gastronomia</h3>
                ...
                <a href="form_gastronomia.php">			
                    <button type="submit" id="button" class="btn btn-block btn-lg" style="font-size: 15px;">
                        ...
                        Cadastrar Gastronomia
                        
                    </button>
                </a>
                
                <a href="visualizar_gastronomia.php">
                    <button type="submit" id="button2" class="btn btn-block btn-lg" style="font-size: 15px;">
                        
                        Alterar / Excluir Gastronomia
