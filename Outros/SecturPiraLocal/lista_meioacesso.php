...
<head>
    ...
    <title>Área Administrativa - Meio de Acesso</title>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <br><br><br><br><br>
                ...
                <h3>Área Administrativa - Meio de Acesso</h3>
                ...
                <a href="form_meioacesso.php">			
                    <button type="submit" id="button" class="btn btn-block btn-lg" style="font-size: 15px;">
                        ...
                        Cadastrar Meio de Acesso
                        
                    </button>
                </a>
                
                <a href="visualizar_meioacesso.php">
                    <button type="submit" id="button2" class="btn btn-block btn-lg" style="font-size: 15px;">
                        
                        Alterar / Excluir Meio de Acesso
