...
<body>
    <?php
        ...
        $consulta = $conexao->query('SELECT * FROM artesanato');
    ...
    <div class="container-fluid">
        ...
        <thead>
            <tr>
                <th style="text-align: center;">Artesanato</th>
        ...
        <div class="row">
            ...
            ?>
                ...
                <tbody>
                    <tr>
                        <td style="padding: 8px; text-align: center; width: 10%;"><?php echo $exibir['artesanatonome']; ?> </td>
                        <td style="padding: 8px; text-align: justify; vertical-align: top; width: 85%;"><?php echo $exibir['artesanatodescricao'] ; ?> </td>

                        <td style="text-align: center; padding: 15px 15px;">
                            <a href="form_alterar_artesanato.php?id=<?php echo $exibir['artesanatoid']; ?>">
                        ...
                        <td style="text-align: center; padding: 18px 18px;">
                            <a href="excluir_artesanato.php?id=<?php echo $exibir['artesanatoid']; ?>">
