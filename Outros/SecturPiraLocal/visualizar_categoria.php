    ...
    <div class="container-fluid">
        ...
        <thead>
            <tr>
                ...
                <th style="text-align: center;">Menu/Status</th>
        ...
        <div class="row">
            ...
            ?>
                ...
                <tbody>
                    <tr>
                        <td style="padding: 8px; text-align: center; width: 10%;"><?php echo $exibir['categorianome'] ; ?> </td>
                        <td style="padding: 8px; text-align: justify; vertical-align: top; width: 85%;"><?php echo $exibir['categoriadescricao'] ; ?> </td>
                        <td style="padding: 4px 4px 0px 4px; text-align: center;"><?php echo $exibir['categoriaseq'] ; ?> </td>
                        <td style="padding: 4px 4px 0px 4px; text-align: center;"><?php echo $exibir['categoriamenu'] ; ?> </td>
                    
                        <td style="text-align: center; padding: 15px 15px;">
                            <a href="form_alterar_categoria.php?id=<?php echo $exibir['categoriaid']; ?>">
                        ...
                        <td style="text-align: center; padding: 18px 18px;">
                            <a href="excluir_categoria.php?id=<?php echo $exibir['categoriaid']; ?>"> 
