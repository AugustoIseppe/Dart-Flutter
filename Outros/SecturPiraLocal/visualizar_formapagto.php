...
<body>
    <?php 
        ...
        $consulta= $conexao->query('SELECT * FROM formapagto');
    ...
    <div class="container-fluid">
        ...
        <thead>
            <tr>
                <th style="text-align: center;">Forma de Pagamento</td>
        ...
        <div class="row">
            ...
            ?>
                ...
                <tbody>
                    <tr>
                        <td style="padding: 8px; text-align: center; width: 60%;"><?php echo $exibir['formapagtonome'] ; ?> </td>
                        
                        <td style="text-align: center; padding: 15px 15px;">
                            <a href="form_alterar_formapagto.php?id=<?php echo $exibir['formapagtoid']; ?>">
                        ...
                        <td style="text-align: center; padding: 18px 18px;">
                            <a href="excluir_formapagto.php?id=<?php echo $exibir['formapagtoid']; ?>">
