...
<body>  	
    <?php 
        ...
        $consulta = $conexao->query('SELECT * FROM formasrecreacao');
    ...
    <div class="container-fluid">
        ...
        <thead>
            <tr>
                <th style="text-align: center;">Forma de Recreação</th>
        ...
        <div class="row">
            ...
            ?>
                ...
                <tbody>
                    <tr>
                        <td style="padding: 8px; text-align: center; width: 60%;"><?php echo $exibir['recreacaonome'] ; ?>
                        
                        <td style="text-align: center; padding: 15px 15px;">
                            <a href="form_alterar_formasrecreacao.php?id=<?php echo $exibir['recreacaoid']; ?>">
                        ...
                        <td style="text-align: center; padding: 18px 18px;">
                            <a href="excluir_formasrecreacao.php?id=<?php echo $exibir['recreacaoid']; ?>"> 
        ...
        <div style="text-align:center">
            <a href="form_formasrecreacao.php">
