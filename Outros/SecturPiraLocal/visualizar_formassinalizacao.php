...
<body>
    <?php 
        ...
        $consulta= $conexao->query('SELECT * FROM formassinalizacao');
    ...
    <div class="container-fluid"> 
        ...
        <thead>
            <tr>
                <th style="text-align: center;">Forma de Sinalização</th>
        ...
        <div class="row">
            ...
            ?>
                ...
                <tbody>
                    <tr>
                        <td style="padding: 8px; text-align: center; width: 60%;"><?php echo $exibir['sinalizacaonome'] ; ?> </td>

                        <td style="text-align: center; padding: 15px 15px;">
                            <a href="form_alterar_formassinalizacao.php?id=<?php echo $exibir['sinalizacaoid']; ?>">
                        ...
                        <td style="text-align: center; padding: 18px 18px;">
                            <a href="excluir_formassinalizacao.php?id=<?php echo $exibir['sinalizacaoid']; ?>">
