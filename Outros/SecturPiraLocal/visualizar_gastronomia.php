...
<body>   	
    <?php 
        ...
        $consulta= $conexao->query('SELECT * FROM gastronomia');
    ?>
    ...
    <div class="container-fluid">
        ...
        <thead>
            <tr>
                <th style="text-align: center;">Gastronomia</th>
        ...
        <div class="row">
            ...
            ?>
                ...
                <tbody>
                    <tr>
                        <td style="padding: 8px; text-align: center; width: 10%;"><?php echo $exibir['gastronomianome'] ; ?> </td>
                        <td style="padding: 8px; text-align: justify; vertical-align: top; width: 85%;"><?php echo $exibir['gastronomiadescricao'] ; ?> </td>
                        
                        <td style="text-align: center; padding: 15px 15px;">
                            <a href="form_alterar_gastronomia.php?id=<?php echo $exibir['gastronomiaid']; ?>">
                        ...
                        <td style="text-align: center; padding: 18px 18px;">
                            <a href="excluir_gastronomia.php?id=<?php echo $exibir['gastronomiaid']; ?>">
