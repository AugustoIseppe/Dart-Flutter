...
<body>   	
    <?php 
        ...
        $consulta= $conexao->query('SELECT * FROM idioma');
    ...
    <div class="container-fluid">
	    ...
	    <div class="row">
            ...
            ?>
                ...
                <tbody>
                    <tr>
                        <td style="padding: 8px; text-align: center; width: 60%;"><?php echo $exibir['idiomanome'] ; ?> </td>

                        <td style="text-align: center; padding: 15px 15px;">
                            <a href="form_alterar_idioma.php?id=<?php echo $exibir['idiomaid']; ?>">
                        ...
                        <td style="text-align: center; padding: 18px 18px;">
                            <a href="excluir_idioma.php?id=<?php echo $exibir['idiomaid']; ?>">
