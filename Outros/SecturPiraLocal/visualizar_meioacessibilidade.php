...
<body>
    <?php
        ...
        $consulta = $conexao->query('SELECT * FROM meioacessibilidade');
    ...
    <div class="container-fluid">
        ...
        <thead>
            <tr>
                <th style="text-align: center;">Acessibilidade</th>
        ...
        <div class="row">
            ...
            ?>
                <tbody>
                    <tr>
                        <td style="padding: 8px; text-align: center; width: 60%;"><?php echo $exibir['acessibilidadenome']; ?> </td>

                        <td style="text-align: center; padding: 15px 15px;">
                            <a href="form_alterar_meioacessibilidade.php?id=<?php echo $exibir['acessibilidadeid']; ?>">
                        ...
                        <td style="text-align: center; padding: 18px 18px;">
                            <a href="excluir_meioacessibilidade.php?id=<?php echo $exibir['acessibilidadeid']; ?>">
