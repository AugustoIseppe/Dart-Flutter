...
<body>	
    <?php 
        ...
        $consulta = $conexao->query('SELECT * FROM meioacesso');
    ...
    <div class="container-fluid">
        ...
        <thead>
            <tr>
                <th style="text-align: center;">Meio de Acesso</th>
        ...
        <div class="row">
            ...
            ?>
                ...
                <tbody>
                    <tr>
                        <td style="padding: 8px; text-align: center; width: 60%;"><?php echo $exibir['meioacessonome'] ; ?> </td>
                        
                        <td style="text-align: center; padding: 15px 15px;">
                            <a href="form_alterar_meioacesso.php?id=<?php echo $exibir['meioacessoid']; ?>">
                        ...
                        <td style="text-align: center; padding: 18px 18px;">
                            <a href="excluir_meioacesso.php?id=<?php echo $exibir['meioacessoid']; ?>">
