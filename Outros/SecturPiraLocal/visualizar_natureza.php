...
<body>
    <?php
        ...
        $consulta = $conexao->query('SELECT * FROM natureza');
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            ?>
                ...
                <tbody>
                    <tr>
                        <td style="padding: 8px; text-align: center; width: 60%;"><?php echo $exibir['naturezanome']; ?> </td>

                        <td style="text-align: center; padding: 15px 15px;">
                            <a href="form_alterar_natureza.php?id=<?php echo $exibir['naturezaid']; ?>">
                        ...
                        <td style="text-align: center; padding: 18px 18px;">
                            <a href="excluir_natureza.php?id=<?php echo $exibir['naturezaid']; ?>">
