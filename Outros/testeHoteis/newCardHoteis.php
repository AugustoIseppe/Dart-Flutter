    ...
    <div id="main-container">
        ...
        <div class="card">
            <div class="image-container">
                ...
                <div class="slider">
                    <div><img src="assets/img/premium1.jpg" alt="Imagem 1"></div>
                    <div><img src="assets/img/premium2.jpg" alt="Imagem 2"></div>
                    <div><img src="assets/img/premium3.jpg" alt="Imagem 3"></div>
                    <div><img src="assets/img/premium4.jpg" alt="Imagem 4"></div>
                    <div><img src="assets/img/premium5.jpg" alt="Imagem 5"></div>
                </div>
            ...
            <div class="content">
                <div class="brand">PREMIUM HOTEL</div>
                <div class="product-name">Pirassununga, São Paulo, Brasil</div>
                <div class="color-size-container">
                    Com estrutura moderna e excelente localização as margens da rodovia Anhanguera, o Habitat Hotel
                    Pirassununga é referência na região.
                    <!-- <div class="colors">
        ...
        <script>
            $(document).ready(function () {
                $('.slider').slick({
                    ...
                    autoplaySpeed: 3000, // Define o intervalo em milissegundos (5 segundos)
